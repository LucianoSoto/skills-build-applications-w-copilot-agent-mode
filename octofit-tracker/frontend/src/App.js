        ...
        <div className="card shadow mb-4">
          <div className="card-body">
            <Routes>
              ...
              <Route path="/" element={<div className="text-center"><h1 className="display-4 mb-3">Bienvenido a Octofit Tracker</h1><p className="lead">Tu app de fitness social y competitiva</p></div>} />
            </Routes>
          </div>
        </div>
      </div>
